...
print('Please unlock your Jade (enter PIN on the device) to continue...')
jade.auth_user('mainnet')
...
for x in range(100):
    ...
    # response = jade.gen_xmss_key(bytes=x.to_bytes(32, "big"))
    response = jade.sign_xmss(path=[44,0,0], message=x.to_bytes(32, "big"))
