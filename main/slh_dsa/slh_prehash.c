                               ...
                               const char *ph)
{
  ...
  else if (strcmp(ph, "SHAKE-128") == 0)
  {
    ...
    mp_sz += 11;
    slh_shake128(mp + mp_sz, 32, m, m_sz);
    mp_sz += 32;
  }
  else if (strcmp(ph, "SHAKE-256") == 0)
  {
    ...
    mp_sz += 11;
    slh_shake256(mp + mp_sz, 64, m, m_sz);
    mp_sz += 64;
  }
  else
  {
