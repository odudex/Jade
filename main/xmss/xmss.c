...
int s_xmss_sign(unsigned char *sk,
              ...
              const unsigned char *m, unsigned long long mlen)
{
    ...
    return xmss_core_sign(&params, sk + XMSS_OID_LEN, sm, smlen, m, mlen, NULL, NULL);
}
                ...
                const unsigned char *m, unsigned long long mlen)
{
    ...
    return xmssmt_core_sign(&params, sk + XMSS_OID_LEN, sm, smlen, m, mlen, NULL, NULL);
}
