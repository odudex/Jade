...
#include "./slh_dsa/sha3_f1600.c"
#include "./slh_dsa/slh_dsa.c"
...
#include "./xmss/hash.c"
#include "./xmss/params.c"
#include "./xmss/randombytes.c"
#include "./xmss/utils.c"
#include "./xmss/wots.c"
#include "./xmss/xmss_commons.c"
#include "./xmss/xmss_core.c"
#include "./xmss/xmss.c"
